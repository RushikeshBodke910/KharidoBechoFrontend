// src/shared/utils/chatStatus.ts

export type ChatRequestStatus = 'PENDING' | 'IN_NEGOTIATION' | 'ACCEPTED' | 'REJECTED' | 'COMPLETED';
...
/**
 * Get status configuration for buyer view
 */
...
/**
 * Get status configuration for seller view
 */
